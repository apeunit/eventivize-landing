...
- #### How to use them
  In order to distribute Drops, audience members just need to scan their favorite artist’s QR code or type in the artist’s wallet address (e.g. @xyz) into their personal wallet. Then, they can select the number of Drops they want to award and hit ‘send’. Think Paypal QR-code payments.
